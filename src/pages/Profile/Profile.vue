  ...
  <div>
    <section class="profile">
      ...
      <!-- 利用router-link实现到Login组件的跳转 -->
        <!-- <router-link :to="userInfo.id ? '/profile': '/login'" class="profile-link"> -->
        <div class="profile-link" @click="goLink">
          <div class="profile_image" @click.stop="imgClick">
          ...
          <span class="arrow" v-if="!userInfo.id">
      ...
      .profile-link
        ...
        .profile_image
          ...
          .img-change
            position absolute
          .icon-yonghuming-1
            background #e4e4e4 url("./images/timg.jpg") center center no-repeat
